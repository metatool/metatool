...
using Clipboard.Core.Desktop.Events;
...
using Clipboard.ComponentModel.Services;
...
namespace Clipboard.ViewModels
{
    ...
    internal sealed class MainWindowViewModel : ViewModelBase
    {
        ...
        private void SetNormalNotifyIcon()
        {
            ...
            icon.BeginInit();
            icon.UriSource = new Uri(@"pack://application:,,,/Clipboard;component/Assets/paste.ico");
            icon.EndInit();
        ...
        private void SetSynchronizingNotifyIcon()
        {
            var icon = new BitmapImage();
            icon.BeginInit();
            icon.UriSource = new Uri(@"pack://application:,,,/Clipboard;component/Assets/paste-sync.ico");
            icon.EndInit();
            NotifyIconSource = icon;
        }
