    ...
    public sealed class ScriptRunner
    {
            ...
            CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                return ImmutableArray.CreateRange(GetCompilation(GetScriptAssemblyName())
                    .GetDiagnostics(cancellationToken).Where(d => d.Severity == DiagnosticSeverity.Warning));
            }
            catch (CompilationErrorException e)
            {
                return ImmutableArray.CreateRange(e.Diagnostics.Where(d =>
        ...
        private static DiagnosticBag DiagnoseCompilation(Compilation compilation,
