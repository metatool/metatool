...
namespace Metaseed.Input
{
    public static class KeysExtensions
    {
        ...
        public static IRemovable Hit(this Keys key, string actionId, string description, Action<KeyEventArgsExt> action, Predicate<KeyEventArgsExt> predicate, bool markHandled = false)
        {
        ...
        public static IRemovable MapOnHit(this Keys key, Keys target, Predicate<KeyEventArgsExt> predicate = null, bool allUp =true)
        {
            return Keyboard.MapOnHit(new Combination(key), new Combination(target), e => predicate == null || predicate(e),allUp);
        }
