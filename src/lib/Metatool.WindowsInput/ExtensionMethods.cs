...
public static class ExtensionMethods
{
	...
	public static Point Center(this Rectangle self) => new(self.Width / 2 + self.Left, self.Height / 2 + self.Top);

	public static Point North(this Rectangle self, int by = 0) => new(self.Center().X, self.Top + by);

	public static Point East(this Rectangle self, int by = 0) => new(self.Right + by, self.Center().Y);

	public static Point South(this Rectangle self, int by = 0) => new(self.Center().X, self.Bottom + by);

	public static Point West(this Rectangle self, int by = 0) => new(self.Left + by, self.Center().Y);
