...
{
	private static readonly HashSet<string> _irrelevantEnumerableProperties = new() { "Count", "Length", "Key" };

	private static readonly HashSet<string> _doNotTreatAsEnumerableTypeNames = new() { "JObject", "JProperty" };

	private static readonly Dictionary<string, string> _toStringAlternatives = new()
	{
		["JArray"] = "[...]",
		["JObject"] = "{...}"
	};
...
[DataContract]
public class InputReadRequest : ResultObject
{
