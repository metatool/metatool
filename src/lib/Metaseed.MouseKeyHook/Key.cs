...
namespace Metaseed.Input
{
    ...
    public class Key
    {
        ...
        public static readonly Key Backtick = Tilde;
        ...
        public static readonly Key Equal = Plus;
        ...
        /// </summary>
        public static readonly Key Crsel = new Key(Keys.Exsel);
        /// <summary>
        ...
        public Keys KeyCode2 { get; private set; }
        public Keys KeyCode3 { get; private set; }


        public Key(Keys keyCodeCode)
        {
            KeyCode = keyCodeCode;
            KeyCode2 = Keys.None;
            KeyCode3 = Keys.None;
        }
        public Key(Keys keyCodeCode, Keys keyCodeCode2)
        {
            KeyCode = keyCodeCode;
            KeyCode2 = keyCodeCode2;
            KeyCode3 = Keys.None;
        }

        public Key(Keys keyCodeCode, Keys keyCodeCode2, Keys keyCodeCode3)
        {
            KeyCode  = keyCodeCode;
            KeyCode2 = keyCodeCode2;
            KeyCode3 = keyCodeCode3;
        }

        public static Combination operator +(Key keyA, Key keyB)
        {
            return new Combination(keyB.KeyCode, keyA.KeyCode);
        }
    }
}
