...
using Clipboard.Shared.Exceptions;
...
namespace Clipboard.Core.Desktop.CloudStorage
{
    /// <summary>
    ...
    internal sealed class OneDriveProvider : ICloudStorageProvider
    {
        ...
        public ControlTemplate CloudServiceIcon
        {
            get
            {
                ...
                resx.Source = new Uri(@"/Clipboard.Core.Desktop;component/CloudStorage/OneDrive.xaml", UriKind.RelativeOrAbsolute);
